    ...
    <Wrap>
      ...
      <Notice>
        ...
        <Bullet>
          ...
          <li>차단/숨김 목록, 푸시 알림 설정</li>
          <li>로그인 인증 정보 (이메일·소셜·전화번호 인증)</li>
        </Bullet>
        <div style={{ marginTop: 10, fontSize: 12, color: "#7f1d1d" }}>
          ※ 작성하신 게시글·댓글·1:1 문의 내역은 자동 삭제되지 않습니다. 탈퇴 후에는 작성자 정보가 사라진 채(‘상대’로 표시) 남으며, 완전 삭제를 원하시면 탈퇴 전에 직접 삭제해주세요.
        </div>
        <div style={{ marginTop: 6, fontSize: 12, color: "#7f1d1d" }}>
          ※ 팀장으로 있는 팀이 있다면, 탈퇴 시 가장 먼저 합류한 팀원에게 팀장이 자동 위임됩니다. 팀원이 없으면 팀이 해체됩니다.
        </div>
      </Notice>
