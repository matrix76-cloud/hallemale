/* eslint-disable */
// src/components/ranking/TeamRankingFilterBottomSheet.jsx
// ✅ 팀 랭킹 전용 필터: 지역(2단계 콤보) + 승률만
// - KR_AREAS 사용 (sido -> guList)
// - draft.regionSido: "all" | "서울" | ...
// - draft.regionGu: "all" | "서초구" | ...
// - draft.winRate: "any" | "70" | "50"
...
export default function TeamRankingFilterBottomSheet({
  open,
  title = "팀 랭킹 필터",
  draft,
  setDraft,
