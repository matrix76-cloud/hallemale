...
export const ADMIN_REVIEW = [
  ...
  { id: "admin-dashboard",       no: "10-01", name: "대시보드",        path: `${ADMIN_BASE}/dashboard`,          spec: [] },
  { id: "admin-login",           no: "10-02", name: "관리자 로그인",   path: `${ADMIN_BASE}/login`,              spec: [] },
  { id: "admin-users-list",      no: "10-03", name: "회원 목록",       path: `${ADMIN_BASE}/users/list`,         spec: [] },
  { id: "admin-users-ranking",   no: "10-04", name: "회원 랭킹",       path: `${ADMIN_BASE}/users/ranking`,      spec: [] },
  { id: "admin-users-reports",   no: "10-05", name: "회원 신고",       path: `${ADMIN_BASE}/users/reports`,      spec: [] },
  { id: "admin-users-blocks",    no: "10-06", name: "회원 차단",       path: `${ADMIN_BASE}/users/blocks`,       spec: [] },
  { id: "admin-teams-list",      no: "10-07", name: "팀 목록",         path: `${ADMIN_BASE}/teams/list`,         spec: [] },
  { id: "admin-teams-ranking",   no: "10-08", name: "팀 랭킹",         path: `${ADMIN_BASE}/teams/ranking`,      spec: [] },
  { id: "admin-teams-reports",   no: "10-09", name: "팀 신고",         path: `${ADMIN_BASE}/teams/reports`,      spec: [] },
  { id: "admin-teams-blocks",    no: "10-10", name: "팀 차단",         path: `${ADMIN_BASE}/teams/blocks`,       spec: [] },
  { id: "admin-matches-list",    no: "10-11", name: "매칭 목록",       path: `${ADMIN_BASE}/matches/list`,       spec: [] },
  { id: "admin-matches-issues",  no: "10-12", name: "분쟁/신고",       path: `${ADMIN_BASE}/matches/issues`,     spec: [] },
  { id: "admin-community-posts", no: "10-13", name: "커뮤니티 글",     path: `${ADMIN_BASE}/community/posts`,    spec: [] },
  { id: "admin-community-detail",no: "10-14", name: "커뮤니티 글 상세", path: `${ADMIN_BASE}/community/posts/${S_POST}`, spec: [] },
  { id: "admin-community-reports",no: "10-15", name: "커뮤니티 신고",  path: `${ADMIN_BASE}/community/reports`,  spec: [] },
  { id: "admin-notify-notices",  no: "10-16", name: "공지 관리",       path: `${ADMIN_BASE}/notify/notices`,     spec: [] },
  { id: "admin-notify-push",     no: "10-17", name: "푸시 발송",       path: `${ADMIN_BASE}/notify/push`,        spec: [] },
  { id: "admin-notify-history",  no: "10-31", name: "발송 로그",       path: `${ADMIN_BASE}/notify/history`,     spec: [] },
  { id: "admin-settings-admins", no: "10-18", name: "관리자 계정",     path: `${ADMIN_BASE}/settings/admins`,    spec: [] },
  { id: "admin-settings-policy", no: "10-19", name: "정책 설정",       path: `${ADMIN_BASE}/settings/policy`,    spec: [] },
  { id: "admin-games-upcoming",  no: "10-20", name: "예정 경기",       path: `${ADMIN_BASE}/games/upcoming`,     spec: [] },
  { id: "admin-games-past",      no: "10-21", name: "지난 경기",       path: `${ADMIN_BASE}/games/past`,         spec: [] },
  { id: "admin-chat-list",       no: "10-22", name: "채팅 목록",       path: `${ADMIN_BASE}/chat/list`,          spec: [] },
  { id: "admin-chat-detail",     no: "10-23", name: "채팅방 상세",     path: `${ADMIN_BASE}/chat/list/${S_CHAT_ADMIN}`, spec: [] },
  { id: "admin-banners",         no: "10-24", name: "배너 관리",       path: `${ADMIN_BASE}/banners`,            spec: [] },
  { id: "admin-venues",          no: "10-25", name: "구장 관리(승인)", path: `${ADMIN_BASE}/venues`,             spec: [] },
  { id: "admin-reservations",    no: "10-30", name: "예약 현황",       path: `${ADMIN_BASE}/reservations`,       spec: [] },
  { id: "admin-settlements",     no: "10-26", name: "정산 관리",       path: `${ADMIN_BASE}/settlements`,        spec: [] },
  { id: "admin-refunds",         no: "10-27", name: "환불 관리",       path: `${ADMIN_BASE}/refunds`,            spec: [] },
  { id: "admin-inquiries",       no: "10-28", name: "문의 관리",       path: `${ADMIN_BASE}/inquiries`,          spec: [] },
  { id: "admin-popups",          no: "10-29", name: "이벤트 팝업",     path: `${ADMIN_BASE}/popups`,             spec: [] },
  { id: "admin-updates",         no: "10-32", name: "앱 업데이트",     path: `${ADMIN_BASE}/updates`,            spec: [] },
];
